...
employee2 = Employee("Суслик", "Шипова", "ж")

# Допишите код для вывода информации о сотрудниках.
print(
    f"Имя: {employee1.first_name}, Фамилия: {employee1.second_name}, Пол: {employee1.gender}, "
    f"Отпускных дней в году: {employee1.vacation_days}."
)
print(
    f"Имя: {employee2.first_name}, Фамилия: {employee2.second_name}, Пол: {employee2.gender}, "
